            ...
            >
              <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold font-display mb-1 group-hover:text-primary transition-colors duration-300">
                      {edu.degree[language]}
                    </h3>
              ...
              {/* What I Learned */}
              <div className="mb-6 p-4 rounded-xl bg-muted/50 group-hover:bg-muted/70 transition-colors duration-300">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {edu.focus[language].map((item, idx) => (
                    <span
                      key={idx}
                      className="px-3 py-1.5 text-sm bg-accent text-accent-foreground rounded-full font-mono hover:bg-primary hover:text-primary-foreground transition-all duration-300 cursor-default hover:scale-105"
                    >
                      {item}
                    </span>
                  ))}
